...
const Footer = () => {
  ...
  const handleSubscribe = (e) => {
    ...
    window.location.href = `https://mail.google.com/mail/?view=cm&fs=1&to=mokshikawaterpurifier@gmail.com&su=Newsletter%20Subscription&body=Please%20subscribe%20me%20to%20the%20newsletter:%20${encodeURIComponent(email)}`;
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center mt-2">
              <FaEnvelope className="mr-2 text-blue-500" />
              <a href="mailto:mokshikawaterpurifier@gmail.com" className={linkClasses}>mokshikawaterpurifier@gmail.com</a>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <form onSubmit={handleSubscribe} className="mt-2">
              ...
              <div className="flex">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 rounded-r-lg text-white text-sm bg-blue-600 hover:bg-blue-700 transition-colors"
                >
                  Subscribe
                </button>
              </div>
              {message && (
                <p className={`mt-2 text-sm ${message.includes('Thank you') ? 'text-green-500' : 'text-red-400'}`}>
                  {message}
                </p>
              )}
            </form>

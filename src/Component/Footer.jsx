...
import { FaFacebook, FaTwitter, FaInstagram, FaLinkedin, FaPhone, FaReact, FaWhatsapp, FaEnvelope } from 'react-icons/fa';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center mt-2">
              ...
              <a href="tel:+919876543210" className={linkClasses}>+91 9368885498</a>
            </div>
            <div className="flex items-center mt-2">
              <FaEnvelope className="mr-2 text-blue-500" />
              <a href="mailto:info@rowater.com" className={linkClasses}>mokshikawaterpurify@gmail.com</a>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col space-y-3">
              ...
              <a href="/gallery" className={linkClasses}>Our Gallery</a>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col space-y-3">
              <a href="/ro-installation" className={linkClasses}>RO Installation</a>
              <a href="/water-purification" className={linkClasses}>Water Purification</a>
              <a href="/annual-maintenance" className={linkClasses}>Annual Maintenance</a>
              <a href="/filter-replacement" className={linkClasses}>Filter Replacement</a>
              <a href="/free-water-testing" className={linkClasses}>Free Water Testing</a>
            </div>
          </div>
